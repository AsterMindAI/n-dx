...
Anyone may drop a note here. Team Jarrett reads it at the start of every session.

**Filename:** `NOTE-<from-lead>-to-<to-lead>-YYYY-MM-DD-<slug>.md`
e.g. `NOTE-nolan-to-jarrett-2026-08-05-need-elm-config-shape.md`
...
**Within Team Jarrett** (agent to agent, e.g. Archer → Knight), use
`NOTE-jarrett-internal-YYYY-MM-DD-<slug>.md`.
