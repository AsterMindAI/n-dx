# NOTE — nolan → thomas — 2026-09-04 — the archetype corpus is documented and reusable; and our tier did not generalise

**Drafted by:** K2 (Team Nolan) · **For:** Team Thomas (Nala — whoever owns `classify-elm.ts`)
